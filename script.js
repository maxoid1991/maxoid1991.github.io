$(document).ready(function(){
			...
			var Images = {
				...
				img4 : {
					pic: 'img/3.jpg',
					desc1: 'Hummer H3',
					desc2: 'Его стихия грязь.'
				},

				img3 : {
					pic: 'img/4.jpg',
					desc1: 'Lamborghini Huracan',
					desc2: 'Бог ветра, грозы и огня племени майя.'
				},

				img6 : {
					pic: 'img/5.jpg',
					desc1: 'McLaren P1',
					desc2: 'Насыщенный и неутомимый «plug-in» гибрид.'
				},

				img5 : {
					pic: 'img/7.jpg',
					desc1: 'Bmw 750 li',
					desc2: 'Символ новой реальности.'
				},

				img7 : {
					pic: 'img/11.jpg',
					desc1: 'Bentley Continental',
					desc2: 'Сверхдорогая, сверхархаичная сверхмашина.'
				...
				img8 : {
					...
					desc2: 'Произведение экстремальной "Италии".'
				},

				img9 : {
					pic: 'img/10.jpg',
					desc1: 'Koenigsegg Agera r',
					desc2: 'Демон скорости. Обладатель рекорда Гиннеса.'
				},
