...
gulp.task('libs', function() {
    return gulp.src([ // берем библиотеки
        ...
        .pipe(concat('libsAll.min.js')) // Собираем их в кучу в новом файле libs.min.js
...
gulp.task('watch', ['browser-sync', 'jade', 'sass', 'libs', 'minCSS'], function() { // При запуске watch выполняеются все таски в скобках
...
gulp.task('default', ['jade', 'sass', 'libs', 'browser-sync', 'watch', 'minCSS']);
...
gulp.task('build', ['clean', 'sass', 'jade', 'libs', 'img', 'minCSS'], function(){
	
	var buildJS = gulp.src('app/js/libsAll.min.js')
